...
const styles = StyleSheet.create({
  ...
  col1: { flex: 4, padding: 3, borderRightWidth: 1, borderRightColor: '#ccc', borderRightStyle: 'solid' },
  col2: { flex: 1, padding: 3, borderRightWidth: 1, borderRightColor: '#ccc', borderRightStyle: 'solid', textAlign: 'center' },
  col3: { flex: 1, padding: 3, borderRightWidth: 1, borderRightColor: '#ccc', borderRightStyle: 'solid', textAlign: 'center' },
  col4: { flex: 1, padding: 3, borderRightWidth: 1, borderRightColor: '#ccc', borderRightStyle: 'solid', textAlign: 'center' },
  col5: { flex: 1.5, padding: 3, borderRightWidth: 1, borderRightColor: '#ccc', borderRightStyle: 'solid', textAlign: 'right' },
  col6: { flex: 1.5, padding: 3, textAlign: 'right' },
  footer: {
    flexDirection: 'row',
    marginTop: 20,
  },
      ...
      <View style={styles.clientSection}>
        <View style={styles.clientLeft}>
          ...
          <View style={styles.fieldValue}>
            ...
            <Text>{data.receptor.provincia}</Text>
          </View>
          <View style={styles.fieldValue}>
...
{/* 
          {qrCodeUrl && (
            <View style={styles.qrSection}>
              ...
              <Text style={[styles.centeredText, { fontSize: 6 }]}>
                VTREF-FC-A-0022-00000499
              </Text>
            </View>
          )} */}

          <View style={{ marginTop: 10, fontSize: 7 }}>
        ...
        <View style={styles.footerRight}>
          <View style={styles.totalRow}>
            <Text>Subtotal:</Text>
            <Text>{data.totales.subtotal.toFixed(2)}</Text>
          </View>
          ...
          <View style={styles.totalRow}>
            <Text>IVA 21,00%:</Text>
            <Text>{data.totales.iva.toFixed(2)}</Text>
          </View>

          <View style={styles.finalTotal}>
            <Text>TOTAL</Text>
            <Text>{data.totales.total.toFixed(2)}</Text>
          </View>
        </View>
      </View>
    </Page>
